...
const projectsData: Project[] = [
  {
    ...
    description:
      'A modern e-commerce platform built with Next.js and microservices architecture. Features include user authentication, payment processing, and real-time inventory management.',
  ...
  },
  {
    ...
    description:
      'An intelligent content generation platform using Gemini API with Redis caching for optimal performance.',
    lang: [
      'Next.js',
      'TypeScript',
      'TailwindCSS',
  ...
  },
  {
    ...
    description:
      'A responsive portfolio website showcasing projects and skills with GitHub API integration.',
  ...
  },
  {
    ...
    description:
      'A real-time messaging application with WebSocket support and modern UI components.',
